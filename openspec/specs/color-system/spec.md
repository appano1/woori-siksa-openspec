...
Defines the raw color palettes (Terracotta and Warm Gray) used as the foundational color primitives for the design system, and their exposure as Tailwind CSS utilities.
