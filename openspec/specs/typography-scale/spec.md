...
Defines the typography token system with 15 semantic tokens across 6 roles, specifying font-size, line-height, letter-spacing, and font-weight for each token. Optimized for Korean readability with Pretendard font family.
